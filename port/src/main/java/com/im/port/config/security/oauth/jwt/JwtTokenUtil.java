...
public class JwtTokenUtil implements Serializable {
    ...
    public Boolean validateToken(String token, PrincipalDetails principalDetails) {
        ...
        log.info(" ### principalDetails.getUserEmail : " + principalDetails.getEmail());
        log.info(" ### isTokenExpired(token) : " + isTokenExpired(token));
        return (userEmail.equals(principalDetails.getEmail()) && !isTokenExpired(token));
    }
}